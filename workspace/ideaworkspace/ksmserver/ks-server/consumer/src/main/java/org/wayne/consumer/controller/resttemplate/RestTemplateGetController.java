...
/**
 * @Description: TestRestTemplate+ribbon 消费服务
 * 启动类注入一个restTemplate并开启负载均衡
 * 分辨开启负载均衡后的的区别
 * <p>
 * RestTemplate 是Spring 3.0的一个http请求工具->类比前端的axios
...
public class RestTemplateGetController {
    ...
    public String hello() throws UnsupportedEncodingException {
        ...
        //开启负责均衡会自动被拦截,根据discoveryClient.getInstances(provide) 从注册表中获得provide地址列表,根据定义的负载均衡策略取访问服务,封装类似如下hello1()方法
