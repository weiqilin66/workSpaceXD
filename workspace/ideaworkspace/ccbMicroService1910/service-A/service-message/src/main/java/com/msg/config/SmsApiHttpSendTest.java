...
public class SmsApiHttpSendTest {
	...
	public void execute() throws Exception{
		...
		sb.append("accountSid").append("=").append(MsgConfig.ACCOUNT_SID);
		sb.append("&to").append("=").append("13163985890");
...
//		sb.append("&smsContent").append("=").append( URLEncoder.encode("【秒嘀科技】您的验证码为123456，该验证码5分钟内有效。请勿泄漏于他人。","UTF-8"));
		String body = sb.toString() + HttpUtil.createCommonParam(MsgConfig.ACCOUNT_SID, MsgConfig.AUTH_TOKEN);
		String result = HttpUtil.post(MsgConfig.BASE_URL, body);
