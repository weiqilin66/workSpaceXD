...
public class SqlGenerator {
    ...
    public static Map<String,String> createTable(Class obj, String tableName) throws IOException {
...
//            System.out.println(column + "," + f.getType());
        ...
        sql = sql.substring(0, lastIndex) + sql.substring(lastIndex + 1)+"\r);";
