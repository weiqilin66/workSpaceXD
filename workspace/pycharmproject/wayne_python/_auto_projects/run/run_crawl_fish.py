...
from _auto_projects.crawl_fish import CrawlFish
from _auto_projects.my_service.my_appium import MyAppium
from _auto_projects.my_service.my_mysql import MySql2
